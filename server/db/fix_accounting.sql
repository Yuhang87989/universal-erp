...
-- 7. 为账套2-5插入印章
INSERT IGNORE INTO seals (book_id, seal_type, seal_name, seal_code, is_filed, is_active, created_at)
...
-- 8. 为账套2-5插入凭证
-- 收款凭证
INSERT IGNORE INTO vouchers (book_id, voucher_type, voucher_no, voucher_date, total_debit, total_credit, is_balanced, status, remark, created_at)
